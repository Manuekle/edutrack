  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center p-4 bg-background overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-[10%] -right-[10%] w-[40%] h-[40%] rounded-full bg-primary/10 blur-[120px] animate-pulse delay-700" />
      </div>
                    ...
                    <FormControl>
                      <div className="relative group">
                        ...
                        <Input
                          ...
                          className="pl-12 pr-4 rounded-xl bg-muted/40 border-border/60 focus:border-primary/50 focus:ring-primary/20 transition-all sm:text-sm text-xs"
                          disabled={isLoading}
                          {...field}
                        />
                      </div>
