                ...
                <div className="relative overflow-x-auto">
                  <Table>
                    <TableHeader className="bg-muted/5">
                      <TableRow className="hover:bg-transparent border-b">
                        <TableHead className="text-[10px] font-semibold px-4 py-3 text-muted-foreground">Código</TableHead>
                        <TableHead className="text-[10px] font-semibold px-4 py-3 text-muted-foreground">Asignatura</TableHead>
                        <TableHead className="text-[10px] font-semibold px-4 py-3 text-muted-foreground">Grupo</TableHead>
                        <TableHead className="text-[10px] font-semibold px-4 py-3 text-muted-foreground">Jornada</TableHead>
                        <TableHead className="text-[10px] font-semibold px-4 py-3 text-muted-foreground">Periodo</TableHead>
                        <TableHead className="text-[10px] font-semibold px-4 py-3 text-muted-foreground">Docente(s)</TableHead>
                        <TableHead className="text-[10px] font-semibold px-4 py-3 text-muted-foreground text-right">Clases</TableHead>
                      ...
                      {createdGroups.map(grp => {
                        ...
                        return (
                          <React.Fragment key={grp.id}>
                            <TableRow className={`hover:bg-muted/20 transition-colors border-b ${isEditing ? 'bg-primary/5' : ''}`}>
                              <TableCell className="px-4 py-3">
                                ...
                                <TableCell colSpan={8} className="px-4 py-3">
                                  <div className="flex flex-wrap items-end gap-3">
                                    ...
                                    <Button
                                      ...
                                      disabled={isSavingGroup}
                                    >
                                      {isSavingGroup ? <Loader2 className="mr-1.5 h-3 w-3 animate-spin" /> : <Save className="mr-1.5 h-3 w-3" />}
                                      Guardar
                                    </Button>
                                    <Button
                                      size="sm"
