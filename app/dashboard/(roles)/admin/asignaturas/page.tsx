          ...
          <div className="flex flex-col gap-4">
            {selectedSubjects.size > 0 && (
              <div className="flex gap-2 justify-end">
                <div className="flex bg-destructive/10 rounded-xl border border-destructive/20 overflow-hidden">
                  <Button
                    variant="ghost"
                      ...
                      {isLoading ? (
                        ...
                        subjects.map(subject => (
                          ...
                          >
                            ...
                            <TableCell className="px-4 py-3">
                              <div className="flex items-center justify-center gap-1.5 bg-muted/30 w-fit mx-auto px-2 py-1 rounded-full">
